Feature: Favorites
    ...
    Scenario: Mostra todos os favorites de um usuário
        ...
        Then o status da resposta deve ser "200"
        And o JSON da resposta deve conter: o id do vídeo "20" e o id do favorito "1", com id do usuário "1" e o id do perfil "1", e o id do vídeo "12" e id do favorito "2", com id do usuário "1" e o id do perfil "1"