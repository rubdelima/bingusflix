...
import categories, {getMovies} from "../../genres_api/ficction_api.js";
import "../Banner.css";
...
function Banner() {
    ...
    const fetchRandomMovie = async () => {
        try{
            const ficction_movies =  categories.find(
                (category) => category.name === "ficction_movies");
            const data = await getMovies(ficction_movies.path);
