...
import categories, {getMovies} from "../../genres_api/comedy_api.js";
import "../Banner.css";
...
function Banner() {
    ...
    const fetchRandomMovie = async () => {
        try{
            const comedy_movies =  categories.find(
                (category) => category.name === "comedy_movies");
            const data = await getMovies(comedy_movies.path);
