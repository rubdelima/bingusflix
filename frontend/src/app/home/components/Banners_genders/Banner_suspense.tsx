...
import categories, {getMovies} from "../../genres_api/suspense_api.js";
import "../Banner.css";
...
function Banner() {
    ...
    const fetchRandomMovie = async () => {
        try{
            const suspense_movies =  categories.find(
                (category) => category.name === "suspense_movies");
            const data = await getMovies(suspense_movies.path);
