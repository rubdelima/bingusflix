...
import categories, {getMovies} from "../../genres_api/romance_api.js";
import "../Banner.css";
...
function Banner() {
    ...
    const fetchRandomMovie = async () => {
        try{
            const romance_movies =  categories.find(
                (category) => category.name === "romance_movies");
            const data = await getMovies(romance_movies.path);
