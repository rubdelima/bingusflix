...
import categories, {getMovies} from "../../genres_api/action_api.js";
import "../Banner.css";
...
function Banner() {
    ...
    const fetchRandomMovie = async () => {
        try{
            const action_movies =  categories.find(
                (category) => category.name === "action_movies");
            const data = await getMovies(action_movies.path);
